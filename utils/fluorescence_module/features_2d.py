...
def shortest_distance_2d(
    ...
    if mp.get_start_method() != 'fork':
        pool_initializer, pool_initargs = _init_shared_contours, (_ALL_CONTOURS,)
    else:
...
def analyze_segmentation_2d(
    ...
    """
    # Physical spacing is required, not defaulted -- see the 3D note.
    spacing_yx = normalise_spacing(spacing_yx, 2)
